...
def init_test():
    ...
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Misha", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Sinchan", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Mark", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Frances", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Alistair", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Alice", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Bob", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Cory", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"David", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Emily", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Federica", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Gail", "email":"example@example.com"})
    newUserEvent.dispatch()
    newUserEvent = Event("NEW_USER", params={"name":"Henry", "email":"example@example.com"})
    newUserEvent.dispatch()
...
def init_demo():
    ...
    locations[1].userJoined(users[14])
    locations[1].userJoined(users[15])
    locations[1].userJoined(users[16])
    locations[1].userJoined(users[17])
    locations[0].userJoined(users[18])
    locations[0].userJoined(users[19])
    locations[0].userJoined(users[20])
    locations[0].userJoined(users[21])
    locations[0].userJoined(users[22])
    locations[0].userJoined(users[23])
    locations[0].userJoined(users[24])
